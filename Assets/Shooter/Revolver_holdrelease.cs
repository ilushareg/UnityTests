...
public class Revolver_holdrelease : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (state == State.Aiming)
        {
            ...
            float fD = (Input.mousePosition - lastMousePos).magnitude;
        ...
        else if (state == State.Shooting)
        {
            ...
            Vector3 vel = (Input.mousePosition - lastMousePos) / Time.deltaTime;
            aim_velocity += vel *3* Time.deltaTime;
